  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-400 via-sky-300 to-sky-500 p-8">
      ...
      <div className="mb-8 flex items-center justify-between rounded-2xl bg-white/70 px-6 py-4 shadow-lg backdrop-blur-md">
        ...
        <Link href="/keys">
          <Button className="flex items-center gap-2 rounded-xl bg-sky-600 text-white shadow-md transition hover:bg-sky-700">
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <Card className="rounded-2xl border border-sky-200 bg-white/90 shadow-md">
          ...
          <CardContent className="space-y-6 text-gray-700">
            <p>
              Use the{" "}
              <code className="rounded bg-gray-200 px-1">x-api-key</code>{" "}
              header. Create a key in{" "}
              <code className="rounded bg-gray-200 px-1">/keys</code> and store
              it securely.
            </p>

            <div>
              <h3 className="font-semibold text-sky-600">Base URL</h3>
              <pre className="overflow-x-auto rounded-lg bg-gray-900 p-3 text-sm text-green-400 shadow-inner">
...
${baseUrl}/api/ping`}</code>
                ...
                <pre className="mt-2 overflow-x-auto rounded-lg bg-gray-900 p-3 text-sm text-green-400 shadow-inner">
        ...
        <Card className="rounded-2xl border border-sky-200 bg-white/90 shadow-md">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              <Button
                onClick={runGet}
                className="rounded-lg bg-sky-600 text-white shadow-md hover:bg-sky-700"
              >
                Test GET /api/ping
              </Button>
              <Button
